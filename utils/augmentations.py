...
def hist_equalize(im, clahe=True, bgr=False):   # 直方图均衡化增强
...
def random_perspective(im,                    # 随机增强
                       targets=(),
                       segments=(),
                       degrees=10,
                       translate=.1,
...
def box_candidates(box1, box2, wh_thr=2, ar_thr=100, area_thr=0.1, eps=1e-16):  # box1(4,n), box2(4,n)      # 框筛选
